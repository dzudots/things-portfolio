...
class AchievementDef:
    ...
    title: str
    description: str
    icon: str  # simple glyph, not emoji spam
...
ACHIEVEMENTS: list[AchievementDef] = [
    AchievementDef(
        "first_thing",
        "Первая вещь",
        "Портфель начался с одной позиции.",
        "◇",
    ...
    AchievementDef(
        "small_collection",
        "Малая коллекция",
        "Три вещи — уже картина имущества.",
        "◈",
        "Держите 3 вещи в портфеле",
    ),
    AchievementDef(
        "household",
        "Домашний учёт",
        "Пять позиций — привычка следить за ценностью.",
        "▣",
        "Держите 5 вещей в портфеле",
    ),
    AchievementDef(
        "phone_in",
        "Связь с рынком",
    ...
    AchievementDef(
        "full_spectrum",
        "Полный спектр",
        "Смартфон, ноут и авто — все категории MVP.",
        "✦",
        "Добавьте по вещи из каждой категории",
    ),
    AchievementDef(
        "cost_known",
        "Знаю, за сколько брал",
        "Указали цену покупки — виден личный P&L.",
        "◎",
        "Укажите цену покупки у вещи",
    ),
    AchievementDef(
        "condition_care",
        "Состояние под контролем",
        "Обновили бакет состояния — оценка честнее.",
        "↻",
        "Измените состояние вещи",
    ),
    AchievementDef(
        "own_view",
        "Своя оценка",
        "Не согласились с рынком и задали override.",
        "◉",
        "Поставьте свою оценку на карточке вещи",
    ),
    AchievementDef(
        "week_habit",
        "Недельная привычка",
        "Открывали портфель в 3 разных дня за месяц.",
        "◷",
        "Заглядывайте в портфель несколько дней",
    ),
    AchievementDef(
        "alert_aware",
        "На пульсе цены",
        "Получили алерт о движении рынка.",
        "◎",
        "Дождитесь сдвига mid или запустите переоценку",
    ),
    AchievementDef(
        "digest_ready",
        "Недельный итог",
        "Появился дайджест имущества.",
        "▤",
        "Включите дайджест и дождитесь понедельника",
    ),
    AchievementDef(
        "data_steward",
        "Хозяин данных",
        "Скачали экспорт — контроль у вас.",
        "⇩",
        "Скачайте экспорт в аккаунте",
    ),
]
